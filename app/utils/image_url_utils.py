...
class ImageURLHandlerUtils:
    ...
    def validate_url_format(url: str):
        """验证URL是否符合服务器规范"""
        expected_prefix = "http://10.0.4.71:8080/file/"
    ...
    def extract_relative_path(url: str) -> str:
        ...
        return url[len("http://10.0.4.71:8080/file/"):].lstrip('/')

    @staticmethod
    def build_local_path(relative_path: str) -> str:
        """将相对路径拼接为本地完整路径"""
        base_path = "/home/zhaohonglong/workspace/Crop_Data"
    ...
    @staticmethod
    def build_full_url(relative_path: str) -> str:
        """将相对路径拼接为完整URL"""
        base_url = "http://10.0.4.71:8080/file/"
